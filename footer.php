    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-12">
                <h4 class="font-rubik font-size-20">Mobile Bazar</h4>
                <p class="font-size-14 font-rale text-white-50">Lorem Repellendus, deserunt.</p>
            </div>
            ...
            <div class="col-lg-4 col-12">
                <h4 class="font-rubik font-size-20">Designers</h4>
                <div class="d-flex flex-column flex-wrap">
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14 text-danger">&copy; Copyrights 2021.All rights Reserved</p>
</div>
<!-- !start #footer -->
